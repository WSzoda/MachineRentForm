...
function FormColumn(props){
    ...
    <form className="column" onSubmit={handleSubmit}>
        ...
        <div className="formBody">
            ...
            <p>od *</p>
            <input type={"date"} name={"dateStart"} value={dateStart} onChange={(e) =>{setDateStart(e.target.value)}}/>
            <p>do *</p>
            <input type={"date"} name={"dateEnd"} value={dateEnd} onChange={(e) =>{setDateEnd(e.target.value)}}/>
            <h3>Miejsce pracy</h3>
            <input type={"text"} placeholder={"Ulica"} name={"street"} id={"street"} value={street} onChange={(e) =>{setStreet(e.target.value)}}/>
            <div className={"split"}>
                <input type={"text"} placeholder={"Kod *"} name={"zipcode"} id={"zipcode"} value={zipcode} onChange={(e) =>{setZipCode(e.target.value)}}/>
                <input type={"text"} placeholder={"Miasto *"} name={"city"} id={"city"} value={city} onChange={(e) =>{setCity(e.target.value)}}/>
            </div>
            ...
            <div className={"split"}>
                <input type={"text"} placeholder={"Imię"} name={"name"} id={"name"} value={name} onChange={(e) =>{setName(e.target.value)}}/>
                <input type={"text"} placeholder={"Nazwisko"} name={"surname"} id={"surname"} value={surname} onChange={(e) =>{setSurname(e.target.value)}}/>
            </div>
            <input type={"text"} placeholder={"Email *"} name={"email"} id={"email"} value={mail} onChange={(e) =>{setMail(e.target.value)}}/>
            <input type={"text"} placeholder={"Telefon *"} name={"phone"} id={"phone"} value={phone} onChange={(e) =>{setPhone(e.target.value)}}/>
            <input type={"text"} placeholder={"Firma"} name={"company"} id={"company"} value={company} onChange={(e) =>{setCompany(e.target.value)}}/>
